...
const platformLinks = [
  { href: "#", label: "Jogos de competição" },
  { href: "#", label: "Gamificação de treinos" },
  { href: "#", label: "Painel de gestão" },
  { href: "#", label: "App do atleta" },
];

const companyLinks = [
  { href: "#", label: "Sobre nós" },
  { href: "#", label: "Depoimentos" },
  { href: "#", label: "Blog" },
  ...
  return (
    <footer className="w-full bg-background border-t border-white/10 pt-12 pb-8 md:pt-16">
      <div className="px-5 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 pb-12">
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Eventos gamificados que transformam academias e boxes em
            ...
            <div className="flex gap-3 mt-5">
              {socialLinks.map(({ href, label, path }) => (
                <Link
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 rounded-full bg-white/5 hover:bg-primary hover:text-background flex items-center justify-center text-muted-foreground transition"
                >
                  <svg
                    viewBox="0 0 24 24"
                    width={16}
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                <Link href="mailto:contato@eventsfitness.com.br" className="hover:text-primary transition">
                  contato@eventsfitness.com.br
                </Link>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-4 text-sm text-muted-foreground text-center">
          <p>© 2026 Bruno Gusmão. Todos os direitos reservados.</p>
